...
public class BalotoDTO extends ApuestaDTO implements Serializable {
	 ...
	 * @param fecha Fecha en la que el apostador realiza la apuesta
	 ...
	 */
	public BalotoDTO(String nombreSede, String cedulaApostador, String fecha, double valor, int[] numerosSeleccionados) {
		super("Baloto", nombreSede, cedulaApostador, fecha, valor);
